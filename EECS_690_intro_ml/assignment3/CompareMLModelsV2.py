...
evaluate_model(lambda : LinearSVC(random_state=0), "SVM")


# In[11]:


evaluate_model(lambda : DecisionTreeClassifier(), "Decision Tree")


# In[13]:


evaluate_model(lambda : RandomForestClassifier(), "Random Forest")


# In[15]:


evaluate_model(lambda : ExtraTreesClassifier(), "Extra Trees")
